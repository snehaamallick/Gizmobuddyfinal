                ...
                <div class="col-md-5">
                    ...
                    <p ng-controller="cartCtrl">
                       ...
                       <!--<a href="/add/${productId}" class="btn btn-warning btn-large" ng-click="addToCart('${product.productId}')"><span class="glyphicon glyphicon-shopping-cart"></span> Order Now</a>-->
                        ...
                        <a href="/cart/add/${product.productId}" class="btn btn-warning btn-large" ng-click="addToCart('${product.productId}')"><span class="glyphicon glyphicon-shopping-cart"></span> Order Now</a>
